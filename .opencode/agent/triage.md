...
Desktop application and browser-based app issues, including `2M_CODE web`, desktop-specific UI behavior, packaging, and web view problems.

### Core

Core 2M_CODE server and harness issues, including sqlite, snapshots, memory, API behavior, agent context construction, tool execution, provider integrations, model behavior, documentation, and larger architectural features.

### Inference

2M_CODE Zen, 2M_CODE Go, and billing issues.
