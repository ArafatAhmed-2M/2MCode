...
- PR #15835: https://github.com/ArafatAhmed-2M/2mcode/pull/15835

## Do Not Translate (Locale Additions)

- `2M_CODE` (preserve casing in prose, docs, and UI copy)
- Keep lowercase `2M_CODE` in commands, package names, paths, URLs, and other exact identifiers
...
- Keep product naming consistent: `2M_CODE` in prose, `2M_CODE` only for exact technical identifiers
...
- Avoid changing `2M_CODE` to `2M_CODE` inside commands, URLs, package names, or code literals
