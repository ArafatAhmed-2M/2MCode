...
Internal package; depended on as `@2M_CODE-ai/http-recorder` from another
workspace package.

```ts
import { HttpRecorder } from "@2M_CODE-ai/http-recorder"
```
...
```ts
import { HttpRecorder, Redactor } from "@2M_CODE-ai/http-recorder"
