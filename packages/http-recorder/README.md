...
Internal package; depended on as `@2mcode-ai/http-recorder` from another
workspace package.

```ts
import { HttpRecorder } from "@2mcode-ai/http-recorder"
```
...
```ts
import { HttpRecorder, Redactor } from "@2mcode-ai/http-recorder"
