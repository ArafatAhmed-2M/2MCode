...
describe("ProxyUtil", () => {
  ...
  describe("headers", () => {
    ...
    test("strips 2M_CODE-specific headers", () => {
      const req = new Request("http://localhost", {
        headers: {
          "x-2M_CODE-directory": "/home/user/project",
      ...
      const result = ProxyUtil.headers(req)
      expect(result.get("x-2M_CODE-directory")).toBeNull()
      expect(result.get("x-2M_CODE-workspace")).toBeNull()
