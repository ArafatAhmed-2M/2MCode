...
describe("HttpApi workspace proxy", () => {
  ...
  it.live("strips 2M_CODE-internal headers and merges extra headers", () =>
    Effect.gen(function* () {
      ...
      expect(forwarded["x-2M_CODE-directory"]).toBeUndefined()
      expect(forwarded["x-2M_CODE-workspace"]).toBeUndefined()
