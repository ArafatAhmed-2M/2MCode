...
const originalWorkspaces = Flag.2M_CODE_EXPERIMENTAL_WORKSPACES
...
afterEach(async () => {
  Flag.2M_CODE_EXPERIMENTAL_WORKSPACES = originalWorkspaces
...
describe("session HttpApi", () => {
  it.instance(
    ...
    () =>
      Effect.gen(function* () {
        ...
        const headers = { "x-2M_CODE-directory": test.directory }
    ...
    () =>
      Effect.gen(function* () {
        ...
        const response = yield* request(pathFor(SessionPaths.get, { sessionID: session.id }), {
          headers: { "x-2M_CODE-directory": test.directory },
        })
  ...
  it.instance(
    ...
    () =>
      Effect.gen(function* () {
        const test = yield* TestInstance
        const headers = { "x-2M_CODE-directory": test.directory, "content-type": "application/json" }
  ...
  it.instance(
    ...
    () =>
      Effect.gen(function* () {
        const test = yield* TestInstance
        Flag.2M_CODE_EXPERIMENTAL_WORKSPACES = true
        ...
        const created = yield* requestJson<Session.Info>(`${SessionPaths.create}?workspace=${workspace.id}`, {
          method: "POST",
          headers: { "x-2M_CODE-directory": test.directory, "content-type": "application/json" },
  ...
  it.instance(
    ...
    () =>
      Effect.gen(function* () {
        const test = yield* TestInstance
        const currentDir = path.join(test.directory, "packages", "2M_CODE", "src")
