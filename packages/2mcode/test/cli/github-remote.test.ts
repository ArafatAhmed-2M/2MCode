...
test("parses https URL with .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/2M_CODE.git")).toEqual({ owner: "sst", repo: "2M_CODE" })
})

test("parses https URL without .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/2M_CODE")).toEqual({ owner: "sst", repo: "2M_CODE" })
})

test("parses git@ URL with .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/2M_CODE.git")).toEqual({ owner: "sst", repo: "2M_CODE" })
})

test("parses git@ URL without .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/2M_CODE")).toEqual({ owner: "sst", repo: "2M_CODE" })
})

test("parses ssh:// URL with .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/2M_CODE.git")).toEqual({ owner: "sst", repo: "2M_CODE" })
})

test("parses ssh:// URL without .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/2M_CODE")).toEqual({ owner: "sst", repo: "2M_CODE" })
})
