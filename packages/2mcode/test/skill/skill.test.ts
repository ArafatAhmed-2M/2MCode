...
describe("skill", () => {
  it.live("discovers skills from .2M_CODE/skill/ directory", () =>
    provideTmpdirInstance(
      (dir) =>
        Effect.gen(function* () {
          yield* Effect.promise(() =>
            Bun.write(
              path.join(dir, ".2M_CODE", "skill", "test-skill", "SKILL.md"),
              `---
name: test-skill
      ...
      (dir) =>
        withHome(
          ...
          Effect.gen(function* () {
            yield* Effect.promise(() =>
              Bun.write(
                path.join(dir, ".2M_CODE", "skill", "dir-skill", "SKILL.md"),
                `---
name: dir-skill
...
`,
            ...
            expect(dirs).toContain(path.join(dir, ".2M_CODE", "skill", "dir-skill"))
  ...
  it.live("discovers multiple skills from .2M_CODE/skill/ directory", () =>
    provideTmpdirInstance(
      (dir) =>
        Effect.gen(function* () {
          yield* Effect.promise(() =>
            Promise.all([
              Bun.write(
                path.join(dir, ".2M_CODE", "skill", "skill-one", "SKILL.md"),
                `---
name: skill-one
...
`,
              ...
              Bun.write(
                path.join(dir, ".2M_CODE", "skill", "skill-two", "SKILL.md"),
                `---
name: skill-two
    ...
    provideTmpdirInstance(
      (dir) =>
        Effect.gen(function* () {
          yield* Effect.promise(() =>
            Bun.write(
              path.join(dir, ".2M_CODE", "skill", "no-frontmatter", "SKILL.md"),
              `# No Frontmatter
    ...
    provideTmpdirInstance(
      (dir) =>
        Effect.gen(function* () {
          yield* Effect.promise(() =>
            Bun.write(
              path.join(dir, ".2M_CODE", "skill", "manual-skill", "SKILL.md"),
              `---
name: manual-skill
---
...
`,
              ...
              Bun.write(
                path.join(dir, ".2M_CODE", "skill", "2M_CODE-skill", "SKILL.md"),
                `---
name: 2M_CODE-skill
description: A skill in the .2M_CODE/skill directory.
---
...
`,
          ...
          const skill = yield* Skill.Service
          const list = (yield* skill.all()).filter((s) => s.location !== "<built-in>")
          expect(list.map((s) => s.name)).toEqual(["2M_CODE-skill"])
        }),
      { git: true },
    ),
  )
...
`,
              ...
              Bun.write(
                path.join(dir, ".2M_CODE", "skill", "agent-skill", "SKILL.md"),
                `---
name: 2M_CODE-skill
description: A skill in the .2M_CODE/skill directory.
---
...
`,
              ...
              Bun.write(
                path.join(dir, ".2M_CODE", "skills", "agent-skill", "SKILL.md"),
                `---
name: 2M_CODE-skill
description: A skill in the .2M_CODE/skills directory.
---
