...
//
// The saved variant persists across sessions in ~/.local/state/2M_CODE/model.json
...
class Service extends Context.Service<Service, VariantService>()("@2M_CODE/RunVariant") {}
