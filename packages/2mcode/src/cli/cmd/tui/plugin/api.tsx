import type { TuiDialogSelectOption, TuiPluginApi, TuiRouteDefinition, TuiSlotProps } from "@2M_CODE-ai/plugin/tui"
...
import type { use2M_CODEKeymap } from "../keymap"
...
type Input = {
  ...
  keymap: ReturnType<typeof use2M_CODEKeymap>
