...
import _2mcodeTheme from "./theme/2M_CODE.json" with { type: "json" }
...
import type { TuiThemeCurrent } from "@2mcode-ai/plugin/tui"
  ...
  init: (props: { mode: "dark" | "light" }) => {
    ...
    setStore(
      produce((draft) => {
        ...
        draft.mode = mode
        draft.lock = lock
        const active = config.theme ?? kv.get("theme", "2M_CODE")
        draft.active = typeof active === "string" ? active : "2M_CODE"
        draft.ready = false
      }),
    )
