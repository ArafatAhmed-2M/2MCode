...
const GO_UPSELL_PROVIDERS = new Set(["2M_CODE", "2M_CODE-go"])
  ...
  createEffect(() => {
    ...
    return exit.message.set(
      [
        ...
        `  ${weak("Continue")}${UI.Style.TEXT_NORMAL_BOLD}2M_CODE -s ${session()?.id}${UI.Style.TEXT_NORMAL}`,
        ``,
      ].join("\n"),
    )
  })
...
function ReasoningPart(props: { last: boolean; part: ReasoningPart; message: AssistantMessage }) {
  ...
  // OpenAI / Copilot / 2M_CODE-via-OpenAI emit `**Title**\n\n<body>` summary
