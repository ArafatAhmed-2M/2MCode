...
export function ErrorComponent(props: {
  ...
  const issueURL = new URL("https://github.com/ArafatAhmed-2M/2mcode/issues/new?template=bug-report.yml")
  ...
  issueURL.searchParams.set("2M_CODE-version", InstallationVersion)
