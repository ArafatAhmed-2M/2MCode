...
import { AgentAttachment, FileAttachment, ReferenceAttachment, Source } from "@2M_CODE-ai/core/session-prompt"
...
export class Service extends Context.Service<Service, Interface>()("@2M_CODE/SessionPrompt") {}
