import { Slug } from "@2M_CODE-ai/core/util/slug"
...
export function plan(input: { slug: string; time: { created: number } }, instance: InstanceContext) {
  const base = instance.project.vcs
    ? path.join(instance.worktree, ".2M_CODE", "plans")
...
export class Service extends Context.Service<Service, Interface>()("@2M_CODE/Session") {}
