...
- [x] 2M_CODE unauthenticated paid-model filtering.
- [x] 2M_CODE public API key fallback.
...
- [x] 2M_CODE small model priority. Replaced by cheapest output cost selection.
