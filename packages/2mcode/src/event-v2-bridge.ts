...
// 2M_CODE and the HTTP event stream still expect legacy bus/sync payloads.
...
export class Service extends Context.Service<Service, EventV2.Interface>()("@2M_CODE/EventV2Bridge") {}
