...
export class Service extends Context.Service<Service, Interface>()("@2M_CODE/Image") {}
  ...
  Effect.gen(function* () {
    ...
    const loadPhoton = yield* Effect.cached(
      Effect.sync(() => {
        ...
        ;(globalThis as typeof globalThis & { __2M_CODE_PHOTON_WASM_PATH?: string }).__2M_CODE_PHOTON_WASM_PATH =
