...
import { NonNegativeInt, optionalOmitUndefined } from "@2mcode-ai/core/schema"
...
> = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const fakeVcs = Schema.decodeUnknownSync(Schema.optional(ProjectVcs))(Flag._2MCODE_FAKE_VCS)
