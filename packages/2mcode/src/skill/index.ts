...
// 2M_CODE.json should look like is often wrong, and 2M_CODE hard-fails on
...
export class Service extends Context.Service<Service, Interface>()("@2M_CODE/Skill") {}
  ...
  Effect.gen(function* () {
    ...
    const state = yield* InstanceState.make(
      Effect.fn("Skill.state")(function* () {
        ...
        s.skills[CUSTOMIZE_2M_CODE_SKILL_NAME] = {
          name: CUSTOMIZE_2M_CODE_SKILL_NAME,
          description: CUSTOMIZE_2M_CODE_SKILL_DESCRIPTION,
          location: "<built-in>",
          content: CUSTOMIZE_2M_CODE_SKILL_BODY,
        }
