...
Practical reference for the current tool-migration state in `packages/2M_CODE`.
...
Tool tests should use the existing Effect helpers in `packages/2M_CODE/test/lib/effect.ts`:
