...
class HeyApiRegistry<T> {
  ...
  get(key?: string): T {
    ...
    if (!instance) {
      throw new Error(`No SDK client found. Create one with "new 2M_CODEClient()" to fix this error.`)
    }
    return instance
  }
...
export class App extends HeyApiClient {
   ...
   * List agents
   *
   * Get a list of all available AI agents in the 2M_CODE system.
   */
   ...
   * List skills
   *
   * Get a list of all available skills in the 2M_CODE system.
   */
...
export class Config extends HeyApiClient {
   ...
   *
   * Retrieve the current global 2M_CODE configuration settings and preferences.
   */
   ...
   *
   * Update global 2M_CODE configuration settings and preferences.
   */
...
export class Global extends HeyApiClient {
   ...
   * Get health
   *
   * Get health information about the 2M_CODE server.
   */
   ...
   * Get global events
   *
   * Subscribe to global events from the 2M_CODE system using server-sent events.
   */
   ...
   * Dispose instance
   *
   * Clean up and dispose all 2M_CODE instances, releasing all resources.
   */
   ...
   * Upgrade 2M_CODE
   *
   * Upgrade 2M_CODE to the specified version or latest if not specified.
   */
...
export class Config2 extends HeyApiClient {
   ...
   * Get configuration
   *
   * Retrieve the current 2M_CODE configuration settings and preferences.
   */
   ...
   *
   * Update 2M_CODE configuration settings and preferences.
   */
  public update<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
...
export class Console extends HeyApiClient {
   ...
   *
   * Persist a new active Console account/org selection for the current local 2M_CODE state.
   */
...
export class Instance extends HeyApiClient {
   ...
   * Dispose instance
   *
   * Clean up and dispose the current 2M_CODE instance, releasing all resources.
   */
...
export class Command extends HeyApiClient {
   ...
   * List commands
   *
   * Get a list of all available commands in the 2M_CODE system.
   */
  public list<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
...
export class Project extends HeyApiClient {
   ...
   * List all projects
   *
   * Get a list of projects that have been opened with 2M_CODE.
   */
  public list<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
   ...
   * Get current project
   *
   * Retrieve the currently active project that 2M_CODE is working with.
   */
...
export class Pty extends HeyApiClient {
   ...
   * List PTY sessions
   *
   * Get a list of all active pseudo-terminal (PTY) sessions managed by 2M_CODE.
   */
  public list<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
...
export class Session2 extends HeyApiClient {
   ...
   * List sessions
   *
   * Get a list of all 2M_CODE sessions, sorted by most recently updated.
   */
  public list<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
   ...
   * Create session
   *
   * Create a new 2M_CODE session for interacting with AI assistants and managing conversations.
   */
  public create<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
   ...
   * Get session
   *
   * Retrieve detailed information about a specific 2M_CODE session.
   */
  public get<ThrowOnError extends boolean = false>(
    parameters: {
      sessionID: string
...
export class 2M_CODEClient extends HeyApiClient {
  public static readonly __registry = new HeyApiRegistry<2M_CODEClient>()

  constructor(args?: { client?: Client; key?: string }) {
    super(args)
    2M_CODEClient.__registry.set(this, args?.key)
  }
