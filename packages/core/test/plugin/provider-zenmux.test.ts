...
import { ProviderPlugins } from "@2mcode-ai/core/plugin/provider"
import { ZenmuxPlugin } from "@2mcode-ai/core/plugin/provider/zenmux"
...
describe("ZenmuxPlugin", () => {
  ...
  it.effect("applies the exact legacy Zenmux headers", () =>
    Effect.gen(function* () {
      ...
      expect(result.provider.options.headers).toEqual({ "HTTP-Referer": "https://2M_CODE.ai/", "X-Title": "2M_CODE" })
