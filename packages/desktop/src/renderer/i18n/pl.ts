export const dict = {
  ...
  "desktop.updater.none.message": "Korzystasz już z najnowszej wersji 2M_CODE",
  ...
  "desktop.updater.downloaded.prompt":
    "Pobrano wersję {{version}} 2M_CODE. Czy chcesz ją zainstalować i uruchomić ponownie?",
  ...
  "desktop.cli.installed.message":
    "CLI zainstalowane w {{path}}\n\nUruchom ponownie terminal, aby użyć polecenia '2M_CODE'.",
