export const dict = {
  ...
  "desktop.updater.none.message": "Ya estás usando la versión más reciente de 2M_CODE",
  ...
  "desktop.updater.downloaded.prompt":
    "Se ha descargado la versión {{version}} de 2M_CODE. ¿Quieres instalarla y reiniciar?",
