export const dict = {
  ...
  "desktop.updater.none.message": "Você já está usando a versão mais recente do 2M_CODE",
  ...
  "desktop.updater.downloaded.prompt":
    "A versão {{version}} do 2M_CODE foi baixada. Você gostaria de instalá-la e reiniciar?",
