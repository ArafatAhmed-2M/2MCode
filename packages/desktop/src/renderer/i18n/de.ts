export const dict = {
  ...
  "desktop.updater.none.message": "Sie verwenden bereits die neueste Version von 2M_CODE",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} von 2M_CODE wurde heruntergeladen. Möchten Sie sie installieren und neu starten?",
  ...
  "desktop.cli.installed.message":
    "CLI wurde in {{path}} installiert\n\nStarten Sie Ihr Terminal neu, um den Befehl '2M_CODE' zu verwenden.",
