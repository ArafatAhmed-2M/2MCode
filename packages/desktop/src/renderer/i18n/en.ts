export const dict = {
  ...
  "desktop.updater.none.message": "You are already using the latest version of 2M_CODE",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} of 2M_CODE has been downloaded, would you like to install it and relaunch?",
  ...
  "desktop.cli.installed.message": "CLI installed to {{path}}\n\nRestart your terminal to use the '2M_CODE' command.",
