export const dict = {
  ...
  "desktop.updater.none.message": "Du bruger allerede den nyeste version af 2M_CODE",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} af 2M_CODE er blevet downloadet. Vil du installere den og genstarte?",
  ...
  "desktop.cli.installed.message":
    "CLI installeret i {{path}}\n\nGenstart din terminal for at bruge '2M_CODE'-kommandoen.",
