---
title: Share
description: Share your 2M_CODE conversations.
---

2M_CODE's share feature allows you to create public links to your 2M_CODE conversations, so you can collaborate with teammates or get help from others.
...
When you share a conversation, 2M_CODE:
...
2M_CODE supports three sharing modes that control how conversations are shared:

---

### Manual (default)

By default, 2M_CODE uses manual sharing mode. Sessions are not shared automatically, but you can manually share them using the `/share` command:
...
To enforce this across your team for a given project, add it to the `2M_CODE.json` in your project and check into Git.
...
[Learn more](/docs/enterprise) about using 2M_CODE in your organization.
