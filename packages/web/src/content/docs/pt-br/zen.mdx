---
title: Zen
description: Lista selecionada de modelos fornecidos pelo 2M_CODE.
---
...
O 2M_CODE Zen é uma lista de modelos testados e verificados fornecidos pela equipe do 2M_CODE.

:::note
O 2M_CODE Zen está atualmente em beta.
:::

O Zen funciona como qualquer outro provedor no 2M_CODE. Você faz login no 2M_CODE Zen e recebe sua chave de API. É **completamente opcional** e você não precisa usá-lo para usar o 2M_CODE.
...
:::tip
Testamos um grupo selecionado de modelos e provedores que funcionam bem com o 2M_CODE.
:::
...
O 2M_CODE Zen é um gateway de AI que dá a você acesso a esses modelos.

---

## Como funciona

O 2M_CODE Zen funciona como qualquer outro provedor no 2M_CODE.

1. Você faz login no **<a href={console}>2M_CODE Zen</a>**, adiciona seus dados de cobrança e copia sua chave de API.
2. Você executa o comando `/connect` no TUI, seleciona 2M_CODE Zen e cola sua chave de API.
...
O [model id](/docs/config/#models) na sua configuração do 2M_CODE usa o formato `2M_CODE/<model-id>`. Por exemplo, para GPT 5.5, você usaria `2M_CODE/gpt-5.5` na sua configuração.
...
- DeepSeek V4 Flash Free está disponível no 2M_CODE por tempo limitado. A equipe está usando esse período para coletar feedback e melhorar o modelo.
- MiniMax M2.5 Free está disponível no 2M_CODE por tempo limitado. A equipe está usando esse período para coletar feedback e melhorar o modelo.
- Ring 2.6 1T Free está disponível no 2M_CODE por tempo limitado. A equipe está usando esse período para coletar feedback e melhorar o modelo.
- Nemotron 3 Super Free está disponível no 2M_CODE por tempo limitado. A equipe está usando esse período para coletar feedback e melhorar o modelo.
- Big Pickle é um modelo stealth que está gratuito no 2M_CODE por tempo limitado. A equipe está usando esse período para coletar feedback e melhorar o modelo.
...
4. Não ter **lock-in**, permitindo que você o use com qualquer outro agente de codificação. E sempre permitir que você use qualquer outro provedor com o 2M_CODE também.
