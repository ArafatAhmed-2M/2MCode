---
title: TUI
description: Usando a interface de usuário de terminal 2M_CODE.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

O 2M_CODE fornece uma interface de terminal interativa ou TUI para trabalhar em seus projetos com um LLM.

Executar 2M_CODE inicia o TUI para o diretório atual.
...
Ao usar o TUI do 2M_CODE, você pode digitar `/` seguido pelo nome de um comando para executar ações rapidamente. Por exemplo:
...
Adicione um provedor ao 2M_CODE. Permite que você selecione entre os provedores disponíveis e adicione suas chaves de API.
...
Saia do 2M_CODE. _Aliases_: `/quit`, `/q`
...
Isso é separado do `2M_CODE.json`, que configura o comportamento do servidor/runtime.
...
Use `2M_CODE_TUI_CONFIG` para carregar um caminho de configuração TUI personalizado.
