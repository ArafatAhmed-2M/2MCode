---
title: IDE
description: The 2M_CODE extension for VS Code, Cursor, and other IDEs
---

2M_CODE integrates with VS Code, Cursor, or any IDE that supports a terminal. Just run `2M_CODE` in the terminal to get started.
...
To install 2M_CODE on VS Code and popular forks like Cursor, Windsurf, VSCodium:

1. Open VS Code
2. Open the integrated terminal
3. Run `2M_CODE` - the extension installs automatically
...
Search for **2M_CODE** in the Extension Marketplace and click **Install**.
...
- Ensure you’re running `2M_CODE` in the integrated terminal.
