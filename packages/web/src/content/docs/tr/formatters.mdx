...
description: 2M_CODE dile özgü biçimlendiriciler kullanır.
---

2M_CODE, dosyaları dile özgü formatlayıcılar kullanılarak yazıldıktan veya düzenlendikten sonra otomatik olarak formatlar. Bu, oluşturulan kodun projenizin kod stillerine uymasını sağlar.

---

## Yerleşik

2M_CODE, popüler diller ve çerçeveler için çeşitli yerleşik biçimlendiricilerle birlikte gelir. Aşağıda ihtiyaç duyduğu biçimlendiricilerin, desteklenen dosya uzantılarının ve komutların veya yapılandırma seçeneklerinin bir listesi bulunmaktadır.
...
Yani eğer projenizin `package.json` dosyasında `prettier` varsa, 2M_CODE bunu otomatik olarak kullanacaktır.

---

## Nasıl çalışır?

2M_CODE bir dosyayı yazdığında veya düzenlediğinde:
...
Biçimlendiricileri 2M_CODE yapılandırmanızdaki `formatter` bölümü aracılığıyla özelleştirebilirsiniz.
