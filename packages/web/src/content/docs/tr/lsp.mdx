...
description: 2M_CODE, LSP sunucularınızla bütünleşir.
---

2M_CODE, LLM'in kod tabanınızla etkileşime girmesine yardımcı olmak için Dil Sunucusu Protokolünüzle (LSP) bütünleşir. LLM'ye geri bildirim sağlamak için tanılamayı kullanır.

---

## Yerleşik

2M_CODE, popüler diller için çeşitli yerleşik LSP sunucularıyla birlikte gelir:
...
:::note
`2M_CODE_DISABLE_LSP_DOWNLOAD` ortam değişkenini `true` olarak ayarlayarak otomatik LSP sunucu indirmelerini devre dışı bırakabilirsiniz.
:::
...
LSP sunucularını, 2M_CODE yapılandırmanızdaki `lsp` bölümü aracılığıyla özelleştirebilirsiniz.
