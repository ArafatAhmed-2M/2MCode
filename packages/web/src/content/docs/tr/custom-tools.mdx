---
title: Özel Araçlar
description: LLM'un 2M_CODE'da çağırabileceği araçları birleştirebilir.
---

Özel araçlar, LLM'un konuşmalar sırasında arayabileceği, oluşturduğunuz işlevlerdir. 2M_CODE'un [built-in tools](/docs/tools) ile birlikte `read`, `write` ve `bash` gibi çalışırlar.
...
- Yerel olarak bunları projenizin `.2M_CODE/tools/` dizinine yerleştirerek.
- Veya küresel olarak bunları `~/.config/2M_CODE/tools/` içine yerleştirerek.
