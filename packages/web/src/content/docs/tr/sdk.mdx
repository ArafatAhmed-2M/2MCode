---
title: SDK
description: 2M_CODE sunucusu için type-safe JS istemcisi.
---

import config from "../../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

2M_CODE JS/TS SDK, sunucu ile etkileşmek için type-safe bir istemci sağlar.
2M_CODE'u programatik olarak kontrol etmek ve entegrasyonlar oluşturmak için kullanabilirsiniz.
...
Davranışı özelleştirmek için bir yapılandırma nesnesi iletebilirsiniz. Örnek yine de `2M_CODE.json` dosyanızı alır, ancak yapılandırmayı satır içi olarak geçersiz kılabilir veya ekleyebilirsiniz:
...
Halihazırda çalışan bir 2M_CODE örneğiniz varsa, ona bağlanmak için bir istemci örneği oluşturabilirsiniz:
