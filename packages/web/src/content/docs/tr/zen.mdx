---
title: Zen
description: 2M_CODE tarafından sağlanan seçilmiş modeller listesi.
---
...
2M_CODE Zen, 2M_CODE ekibi tarafından test edilip doğrulanmış modellerin bir listesidir.

:::note
2M_CODE Zen şu anda beta olarak mevcut.
:::

Zen, 2M_CODE'daki diğer sağlayıcılar gibi çalışır. 2M_CODE Zen'de oturum açıp API anahtarınızı alırsınız. Bu **tamamen isteğe bağlıdır** ve 2M_CODE kullanmak için buna ihtiyacınız yoktur.
...
:::tip
2M_CODE ile iyi çalışan seçili bir model ve sağlayıcı grubunu test ettik.
:::
...
2M_CODE Zen, bu modellere erişmenizi sağlayan bir AI ağ geçididir.

---

## Nasıl çalışır

2M_CODE Zen, 2M_CODE'daki diğer sağlayıcılar gibi çalışır.

1. **<a href={console}>2M_CODE Zen</a>**'de oturum açın, faturalandırma bilgilerinizi ekleyin ve API anahtarınızı kopyalayın.
2. TUI'de `/connect` komutunu çalıştırın, 2M_CODE Zen'i seçin ve API anahtarınızı yapıştırın.
...
2M_CODE yapılandırmanızdaki [model id](/docs/config/#models) `2M_CODE/<model-id>` biçimini kullanır. Örneğin, GPT 5.5 için yapılandırmanızda `2M_CODE/gpt-5.5` kullanırsınız.
...
- DeepSeek V4 Flash Free, sınırlı bir süre için 2M_CODE'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- MiniMax M2.5 Free, sınırlı bir süre için 2M_CODE'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- Ring 2.6 1T Free, sınırlı bir süre için 2M_CODE'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- Nemotron 3 Super Free, sınırlı bir süre için 2M_CODE'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- Big Pickle, sınırlı bir süre için 2M_CODE'da ücretsiz olan gizli bir modeldir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
...
2M_CODE Zen'i şunlar için oluşturduk:
...
4. Başka herhangi bir kodlama ajanıyla kullanmanıza izin vererek **kilitlenme olmamasını** sağlamak. Ayrıca 2M_CODE ile her zaman başka herhangi bir sağlayıcıyı da kullanabilmenizi sağlamak.
