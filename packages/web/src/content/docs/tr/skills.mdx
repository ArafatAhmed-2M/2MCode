...
Ajan becerileri, 2M_CODE'un deponuzdan veya ev dizininizden tekrar kullanilabilir talimatlari kesfetmesini saglar.
...
2M_CODE su konumlari tarar:

- Proje konfigurasyonu: `.2M_CODE/skills/<name>/SKILL.md`
- Genel konfigurasyon: `~/.config/2M_CODE/skills/<name>/SKILL.md`
...
Proje yerel yollarinda 2M_CODE, mevcut calisma dizininizden baslayip git worktree kokune kadar yukari cikar.
Bu sirada `skills/*/SKILL.md` altindaki eslesen `.2M_CODE/` dosyalarini ve `.claude/skills/*/SKILL.md` ya da `.agents/skills/*/SKILL.md` dosyalarini yukler.

Genel tanimlar da `~/.config/2M_CODE/skills/*/SKILL.md`, `~/.claude/skills/*/SKILL.md` ve `~/.agents/skills/*/SKILL.md` yollarindan yuklenir.
...
`.2M_CODE/skills/git-release/SKILL.md` dosyasini soyle olusturun:
...
2M_CODE, `skill` araci aciklamasinda mevcut becerileri listeler.
...
`2M_CODE.json` icinde pattern tabanli izinlerle ajanlarin hangi becerilere erisecegini kontrol edin:
...
**Yerlesik ajanlar icin** (`2M_CODE.json` icinde):
