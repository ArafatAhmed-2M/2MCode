---
title: Teilen
description: Teile 2M_CODE-Unterhaltungen per oeffentlichem Link.
---

Mit der Share-Funktion erstellst du oeffentliche Links zu 2M_CODE-Unterhaltungen.
...
Wenn du eine Unterhaltung teilst, macht 2M_CODE Folgendes:
...
2M_CODE hat drei Modi, die das Teilen steuern:

---

### Manuell (Standard)

Standardmaessig nutzt 2M_CODE den manuellen Modus.
...
Wenn das fuer ein Projekt teamweit gelten soll, lege es in der Projekt-`2M_CODE.json` fest und committe die Datei.
...
[Mehr dazu](/docs/enterprise), wie du 2M_CODE in deiner Organisation einsetzt.
