---
title: Zen
description: Kuratierte Modellliste direkt von 2M_CODE.
---
...
2M_CODE Zen ist eine Liste von getesteten und verifizierten Modellen, die vom 2M_CODE-Team bereitgestellt wird.

:::note
2M_CODE Zen befindet sich derzeit in der Beta.
:::

Zen funktioniert wie jeder andere Provider in 2M_CODE. Du meldest dich bei 2M_CODE Zen an und erhältst deinen API-Key. Es ist **vollständig optional** und du musst es nicht verwenden, um 2M_CODE zu nutzen.
...
:::tip
Wir haben eine ausgewählte Gruppe von Modellen und Providern getestet, die gut mit 2M_CODE funktionieren.
:::
...
2M_CODE Zen ist ein AI-Gateway, das dir Zugriff auf diese Modelle gibt.

---

## So funktioniert es

2M_CODE Zen funktioniert wie jeder andere Provider in 2M_CODE.

1. Du meldest dich bei **<a href={console}>2M_CODE Zen</a>** an, hinterlegst deine Zahlungsdaten und kopierst deinen API-Key.
2. Du führst den Befehl `/connect` in der TUI aus, wählst 2M_CODE Zen aus und fügst deinen API-Key ein.
...
Die [Model-ID](/docs/config/#models) in deiner 2M_CODE-Konfiguration verwendet das Format `2M_CODE/<model-id>`. Für GPT 5.5 würdest du zum Beispiel `2M_CODE/gpt-5.5` in deiner Konfiguration verwenden.
...
- DeepSeek V4 Flash Free ist für begrenzte Zeit auf 2M_CODE verfügbar. Das Team nutzt diese Zeit, um Feedback zu sammeln und das Modell zu verbessern.
- MiniMax M2.5 Free ist für begrenzte Zeit auf 2M_CODE verfügbar. Das Team nutzt diese Zeit, um Feedback zu sammeln und das Modell zu verbessern.
- Ring 2.6 1T Free ist für begrenzte Zeit auf 2M_CODE verfügbar. Das Team nutzt diese Zeit, um Feedback zu sammeln und das Modell zu verbessern.
- Nemotron 3 Super Free ist für begrenzte Zeit auf 2M_CODE verfügbar. Das Team nutzt diese Zeit, um Feedback zu sammeln und das Modell zu verbessern.
- Big Pickle ist ein Stealth-Modell, das für begrenzte Zeit kostenlos auf 2M_CODE verfügbar ist. Das Team nutzt diese Zeit, um Feedback zu sammeln und das Modell zu verbessern.
...
Wir haben 2M_CODE Zen geschaffen, um:
...
4. **keinen Lock-in** zu haben, indem du es mit jedem anderen Coding-Agenten verwenden kannst. Und dir außerdem immer zu erlauben, mit 2M_CODE auch jeden anderen Provider zu verwenden.
