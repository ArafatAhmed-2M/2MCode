...
Erstellen Sie `.2M_CODE/commands/test.md`:

```md title=".2M_CODE/commands/test.md"
---
...
Sie können benutzerdefinierte Befehle über die 2M_CODE-Konfiguration hinzufügen oder indem Sie Markdown-Dateien im Verzeichnis `commands/` erstellen.

---

### JSON

Verwenden Sie die Option `command` in Ihrem 2M_CODE [config](/docs/config):

```json title="2M_CODE.jsonc" {4-12}
{
...
- Global: `~/.config/2M_CODE/commands/`
- Pro Projekt: `.2M_CODE/commands/`

```markdown title="~/.config/2M_CODE/commands/test.md"
---
description: Run tests with coverage
agent: build
model: anthropic/claude-3-5-sonnet-20241022
...
```md title=".2M_CODE/commands/component.md"
---
...
```md title=".2M_CODE/commands/create-file.md"
---
...
```md title=".2M_CODE/commands/analyze-coverage.md"
---
...
```md title=".2M_CODE/commands/review-changes.md"
---
...
```md title=".2M_CODE/commands/review-component.md"
---
...
2M_CODE enthält mehrere integrierte Befehle wie `/init`, `/undo`, `/redo`, `/share`, `/help`; [mehr erfahren](/docs/tui#commands).
