---
title: TUI
description: Arbeite mit 2M_CODE in der Terminal-Oberflaeche.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

2M_CODE bietet eine interaktive Terminaloberflaeche (TUI), um mit einem LLM an deinen Projekten zu arbeiten.

Ohne weitere Argumente startet 2M_CODE die TUI im aktuellen Verzeichnis.
...
In der 2M_CODE-TUI kannst du `/` plus Befehlsnamen eingeben, um Aktionen schnell auszufuehren.
Zum Beispiel:
...
Fuegt einen Provider zu 2M_CODE hinzu. Erlaubt die Auswahl aus verfuegbaren Providern und das Hinzufuegen ihrer API-Keys.
...
Beendet 2M_CODE. _Aliase_: `/quit`, `/q`
...
Dies ist getrennt von `2M_CODE.json`, welche das Server-/Runtime-Verhalten konfiguriert.
...
Verwende `2M_CODE_TUI_CONFIG`, um einen benutzerdefinierten TUI-Konfigurationspfad zu laden.
