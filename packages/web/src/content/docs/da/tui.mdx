---
title: TUI
description: Brug af 2M_CODE-terminalbrugergrænsefladen.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

2M_CODE giver en interaktiv terminalgrænseflade eller TUI til at arbejde med dine projekter med en LLM.

At køre 2M_CODE starter TUI for den nuværende mappe.
...
Når du bruger 2M_CODE TUI, kan du skrive `/` efterfulgt af et kommandonavn for hurtigt at udføre handlinger. For eksempel:
...
Tilføj en udbyder til 2M_CODE. Lader dig vælge fra tilgængelige udbydere og tilføje deres API-nøgler.
...
Afslut 2M_CODE. _Aliaser_: `/quit`, `/q`
...
Dette er adskilt fra `2M_CODE.json`, som konfigurerer server-/kørselstidsadfærd.
...
Brug `2M_CODE_TUI_CONFIG` til at indlæse en brugerdefineret TUI-konfigurationssti.
