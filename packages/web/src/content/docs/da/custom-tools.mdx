...
description: Opret værktøjer, som LLM kan kalde 2M_CODE ind.
---

Brugerdefinerede værktøjer er funktioner, du opretter, som LLM kan kalde under samtaler. De arbejder sammen med 2M_CODEs [built-in tools](/docs/tools) som `read`, `write` og `bash`.
...
- Lokalt ved at placere dem i biblioteket `.2M_CODE/tools/` i dit projekt.
- Eller globalt ved at placere dem i `~/.config/2M_CODE/tools/`.
