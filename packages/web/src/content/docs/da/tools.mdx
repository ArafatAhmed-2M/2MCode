...
Her er alle de innebygde verktøyene som er tilgængelige i 2M_CODE.
...
:::note
Dette verktøyet er bare tilgængelig når `2M_CODE_EXPERIMENTAL_LSP_TOOL=true` (eller `2M_CODE_EXPERIMENTAL=true`).
:::
...
:::note
Dette verktøyet er bare tilgængelig når du bruger 2M_CODE-leverandøren eller når miljøvariabelen `2M_CODE_ENABLE_EXA` er satt til en sannverdi (f.eks. `true` eller `1`).
