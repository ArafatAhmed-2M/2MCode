---
title: Deling
description: Del dine 2M_CODE-samtaler.
---

2M_CODEs delingsfunksjon lar deg lage offentlige lenker til dine 2M_CODE-samtaler, slik at du kan samarbeide med lagkamerater eller få hjelp fra andre.
...
Når du deler en samtale, 2M_CODE:
...
2M_CODE støtter tre delingsmoduser som kontrollerer hvordan samtaler deles:

---

### Manuel (standard)

Som standard bruger 2M_CODE manuell delingsmodus. Sessioner deles ikke automatisk, men du kan dele dem manuelt ved at bruge kommandoen `/share`:
...
For at håndheve dette på tvers av teamet ditt for et gitt prosjekt, tilføj det til `2M_CODE.json` i prosjektet ditt og tjek inn i Git.
...
[Finn ut mer](/docs/enterprise) om brug av 2M_CODE i organisasjonen din.
