---
title: LSP-servere
description: 2M_CODE integreres med dine LSP-servere.
---

2M_CODE integreres med Language Server Protocol (LSP) for at hjælpe LLM med at interagere med din kodebase. Den bruger diagnostik til at give feedback til LLM.

---

## Indbyggede

2M_CODE leveres med flere indbyggede LSP-servere til populære sprog:
...
:::note
Du kan deaktivere automatisk LSP-serverdownloads ved at indstille miljøvariablen `2M_CODE_DISABLE_LSP_DOWNLOAD` til `true`.
:::
...
Når 2M_CODE åbner en fil, vil den:
...
Du kan tilpasse LSP-servere gennem sektionen `lsp` i din 2M_CODE-konfiguration.
