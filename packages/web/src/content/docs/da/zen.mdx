---
title: Zen
description: Udvalgt liste over modeller leveret af 2M_CODE.
---
...
2M_CODE Zen er en liste over testede og verificerede modeller leveret af 2M_CODE-teamet.

:::note
2M_CODE Zen er i øjeblikket i beta.
:::

Zen fungerer som enhver anden udbyder i 2M_CODE. Du logger ind på 2M_CODE Zen og får
...
:::tip
Vi testede en udvalgt gruppe modeller og udbydere, som fungerer godt med 2M_CODE.
:::
...
2M_CODE Zen er en AI gateway, der giver dig adgang til disse modeller.

---

## Sådan fungerer det

2M_CODE Zen fungerer som enhver anden udbyder i 2M_CODE.

1. Du logger ind på **<a href={console}>2M_CODE Zen</a>**, tilføjer dine faktureringsoplysninger
   og kopierer din API-nøgle.
2. Du kører kommandoen `/connect` i TUI, vælger 2M_CODE Zen og indsætter din API-nøgle.
...
[model id](/docs/config/#models) i din 2M_CODE-konfiguration
bruger formatet `2M_CODE/<model-id>`. For eksempel ville du for GPT 5.5
bruge `2M_CODE/gpt-5.5` i din konfiguration.
...
- DeepSeek V4 Flash Free er tilgængelig på 2M_CODE i en begrænset periode. Teamet bruger denne tid til at indsamle feedback og forbedre modellen.
- MiniMax M2.5 Free er tilgængelig på 2M_CODE i en begrænset periode. Teamet bruger denne tid til at indsamle feedback og forbedre modellen.
- Ring 2.6 1T Free er tilgængelig på 2M_CODE i en begrænset periode. Teamet bruger denne tid til at indsamle feedback og forbedre modellen.
- Nemotron 3 Super Free er tilgængelig på 2M_CODE i en begrænset periode. Teamet bruger denne tid til at indsamle feedback og forbedre modellen.
- Big Pickle er en stealth-model, som er gratis på 2M_CODE i en begrænset periode. Teamet bruger denne tid til at indsamle feedback og forbedre modellen.
...
4. Have **ingen lock-in** ved at lade dig bruge det med enhver anden kodeagent. Og altid lade dig bruge enhver anden udbyder med 2M_CODE også.
