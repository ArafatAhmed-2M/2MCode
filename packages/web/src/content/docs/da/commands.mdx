...
Opret `.2M_CODE/commands/test.md`:
...
Du kan tilføje brugerdefinerede kommandoer gennem 2M_CODE-konfigurationen eller ved at oprette markdown-filer i `commands/`-mappen.

---

### JSON

Brug indstillingerne `command` i din 2M_CODE [config](/docs/config):
...
- Globalt: `~/.config/2M_CODE/commands/`
- Pr. projekt: `.2M_CODE/commands/`
...
2M_CODE indeholder flere indbyggede kommandoer som `/init`, `/undo`, `/redo`, `/share`, `/help`; [learn more](/docs/tui#commands).
