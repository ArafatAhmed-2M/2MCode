...
Agentferdigheter lar 2M_CODE oppdage gjenbrugbare instruksjoner fra repo- eller hjemmekatalogen din.
...
2M_CODE søker etter disse stedene:

- Prosjektkonfigurasjon: `.2M_CODE/skills/<name>/SKILL.md`
- Global konfigurasjon: `~/.config/2M_CODE/skills/<name>/SKILL.md`
...
For prosjektlokale stier går 2M_CODE opp fra din nåværende arbejdskatalog til den når git-arbeidstreet.
Den laster alle matchende `skills/*/SKILL.md` i `.2M_CODE/` og alle matchende `.claude/skills/*/SKILL.md` eller `.agents/skills/*/SKILL.md` underveis.

Globale definisjoner lastes også inn fra `~/.config/2M_CODE/skills/*/SKILL.md`, `~/.claude/skills/*/SKILL.md` og `~/.agents/skills/*/SKILL.md`.
...
Lag `.2M_CODE/skills/git-release/SKILL.md` slik:
...
2M_CODE viser tilgængelige ferdigheter i `skill` verktøybeskrivelsen.
...
Kontroller hvilke ferdigheter agenter har tilgang til ved at bruge mønsterbaserte tillatelser i `2M_CODE.json`:
...
**For innebygde agenter** (i `2M_CODE.json`):
