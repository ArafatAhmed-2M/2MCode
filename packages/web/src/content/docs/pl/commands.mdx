...
Utwórz `.2M_CODE/commands/test.md`:
...
Możesz zdefiniować polecenia w `2M_CODE.json` lub w plikach w katalogu `commands/`.

---

### JSON

Użyj opcji `command` w swojej konfiguracji 2M_CODE:
...
- Globalnie: `~/.config/2M_CODE/commands/`
- Na projekt: `.2M_CODE/commands/`
...
2M_CODE zawiera kilka wbudowanych poleceń, takich jak `/init`, `/undo`, `/redo`, `/share`, `/help`; [dowiedz się więcej](/docs/tui#commands).
