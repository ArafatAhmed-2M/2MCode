---
title: Udostępnianie
description: Udostępnij swoje rozmowy dotyczące 2M_CODE.
---

Funkcja udostępniania 2M_CODE umożliwia tworzenie publicznych linków do konwersacji 2M_CODE, dzięki czemu możesz współpracować z członkami zespołu lub uzyskać pomoc od innych.
...
Kiedy udostępniasz rozmowę, 2M_CODE:
...
2M_CODE obsługuje trzy tryby udostępniania, które kontrolują sposób udostępniania rozmów:

---

### Ręczne (domyślne)

Domyślnie 2M_CODE korzysta z ręcznego trybu udostępniania. Sesje nie są udostępniane automatycznie, ale możesz je udostępnić ręcznie za pomocą polecenia `/share`:
...
Aby wymusić to w całym zespole dla danego projektu, dodaj go do `2M_CODE.json` w swoim projekcie i sprawdź w Git.
...
[Dowiedz się więcej](/docs/enterprise) o używaniu 2M_CODE w Twojej organizacji.
