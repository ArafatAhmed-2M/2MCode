---
title: TUI
description: Korzystanie z interfejsu użytkownika terminala 2M_CODE.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

2M_CODE zapewnia interaktywny interfejs terminala lub TUI do pracy nad projektami za pomocą LLM.

Uruchomienie 2M_CODE uruchamia TUI dla bieżącego katalogu.
...
Korzystając z TUI 2M_CODE, możesz wpisać `/`, po którym następuje nazwa polecenia, aby szybko wykonać działania. Na przykład:
...
Dodaj dostawcę do 2M_CODE. Umożliwia wybór dostępnych dostawców i dodanie ich kluczy API.
...
Zamknij 2M_CODE. _Aliasy_: `/quit`, `/q`
...
Jest to oddzielny plik od `2M_CODE.json`, który konfiguruje zachowanie serwera/runtime.
...
Użyj `2M_CODE_TUI_CONFIG`, aby załadować niestandardową ścieżkę konfiguracji TUI.
