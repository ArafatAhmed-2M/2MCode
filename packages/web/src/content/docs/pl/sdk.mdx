---
title: SDK
description: Typowany klient JS dla serwera 2M_CODE.
---

import config from "../../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

Pakiet SDK JS/TS 2M_CODE zapewnia klienta z bezpiecznym typowaniem (type-safe) do interakcji z serwerem.
Użyj go do budowania integracji i programowej kontroli 2M_CODE.
...
Można przekazać obiekt konfiguracyjny, aby dostosować zachowanie. Instancja nadal pobiera `2M_CODE.json`, ale możesz zastąpić lub dodać konfigurację bezpośrednio:
...
Jeśli masz już działającą instancję 2M_CODE, możesz utworzyć instancję klienta, aby się z nią połączyć:
