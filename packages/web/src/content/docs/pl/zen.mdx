---
title: Zen
description: Wyselekcjonowana lista modeli dostarczonych przez 2M_CODE.
---
...
2M_CODE Zen to lista przetestowanych i zweryfikowanych modeli udostępniana przez zespół 2M_CODE.

:::note
2M_CODE Zen jest obecnie w wersji beta.
:::

Zen działa jak każdy inny dostawca w 2M_CODE. Logujesz się do 2M_CODE Zen i otrzymujesz
...
:::tip
Przetestowaliśmy wybraną grupę modeli i dostawców, którzy dobrze współpracują z 2M_CODE.
:::
...
2M_CODE Zen to brama AI, która daje dostęp do tych modeli.

---

## Jak to działa

2M_CODE Zen działa jak każdy inny dostawca w 2M_CODE.

1. Logujesz się do **<a href={console}>2M_CODE Zen</a>**, dodajesz dane
   rozliczeniowe i kopiujesz swój klucz API.
2. Uruchamiasz polecenie `/connect` w TUI, wybierasz 2M_CODE Zen i wklejasz swój klucz API.
...
[ID modelu](/docs/config/#models) w Twojej konfiguracji 2M_CODE używa formatu
`2M_CODE/<model-id>`. Na przykład dla GPT 5.5 użyjesz w konfiguracji
`2M_CODE/gpt-5.5`.
...
- DeepSeek V4 Flash Free jest dostępny w 2M_CODE przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- MiniMax M2.5 Free jest dostępny w 2M_CODE przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- Ring 2.6 1T Free jest dostępny w 2M_CODE przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- Nemotron 3 Super Free jest dostępny w 2M_CODE przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- Big Pickle to stealth model, który jest darmowy w 2M_CODE przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
...
4. Nie tworzyć **lock-in**, pozwalając używać tego z dowolnym innym agentem kodującym. I zawsze pozwalać Ci używać w 2M_CODE także dowolnego innego dostawcy.
