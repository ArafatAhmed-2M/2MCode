---
title: TUI
description: استخدام واجهة المستخدم TUI في 2M_CODE.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

يوفّر 2M_CODE واجهة terminal تفاعلية (TUI) للعمل على مشاريعك باستخدام LLM.

يؤدي تشغيل 2M_CODE إلى بدء واجهة TUI للدليل الحالي.
...
عند استخدام واجهة 2M_CODE في terminal، يمكنك كتابة `/` متبوعة باسم أمر لتنفيذ الإجراءات بسرعة. مثلا:
...
أضف موفّرا إلى 2M_CODE. يتيح لك اختيار أحد الموفّرين المتاحين وإضافة مفاتيح API الخاصة بهم.
...
اخرج من 2M_CODE. _الأسماء المستعارة_: `/quit`, `/q`
...
يمكنك تخصيص سلوك واجهة TUI عبر ملف إعدادات 2M_CODE.
...
استخدم `2M_CODE_TUI_CONFIG` لتحميل مسار إعدادات TUI مخصص.
