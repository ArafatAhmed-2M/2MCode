...
description: أنشئ أدوات يمكن لـ LLM استدعاؤها في 2M_CODE.
---

الأدوات المخصصة هي دوال تنشئها يمكن لـ LLM استدعاؤها أثناء المحادثات. تعمل جنبا إلى جنب مع [الأدوات المدمجة](/docs/tools) في 2M_CODE مثل `read` و`write` و`bash`.
...
- محليا بوضعها في مجلد `.2M_CODE/tools/` داخل مشروعك.
- أو عالميا بوضعها في `~/.config/2M_CODE/tools/`.
