...
Prilagođeni alati su funkcije koje kreirate i koje LLM može pozvati tokom razgovora. Oni rade zajedno sa [ugrađenim 2M_CODE](/docs/tools) alatima kao što su `read`, `write` i `bash`.
...
- Lokalno postavljanjem u `.2M_CODE/tools/` direktorij vašeg projekta.
- Ili globalno, postavljanjem u `~/.config/2M_CODE/tools/`.
