---
title: Dijeljenje
description: Dijelite 2M_CODE razgovore javnim linkovima.
---

2M_CODE opcija dijeljenja vam omogucava da kreirate javne linkove za razgovore. Tako lakse saradujete s timom ili trazite pomoc od drugih.
...
Kada podijelite razgovor, 2M_CODE:
...
2M_CODE podrzava tri nacina dijeljenja koji odreduju kako se razgovori dijele:

---

### Ručno (zadano)

Po defaultu, 2M_CODE koristi rucni nacin dijeljenja. Sesije se ne dijele automatski, ali ih mozete rucno podijeliti komandom `/share`:
...
Da ovo vazi za cijeli tim u odredenom projektu, dodajte postavku u projektni `2M_CODE.json` i commitujte u Git.
...
[Saznajte vise](/docs/enterprise) o koristenju 2M_CODE u organizaciji.
