---
title: TUI
description: Korištenje korisničkog interfejsa 2M_CODE terminala.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

2M_CODE pruža interaktivni terminalski interfejs ili TUI za rad na vašim projektima sa LLM.

Pokretanje 2M_CODE pokreće TUI za trenutni direktorij.
...
Kada koristite 2M_CODE TUI, možete upisati `/` nakon čega slijedi ime komande da biste brzo izvršili radnje. na primjer:
...
Dodajte provajdera u 2M_CODE. Omogućava vam da odaberete između dostupnih provajdera i dodate njihove API ključeve.
...
Izađite iz 2M_CODE. _Aliases_: `/quit`, `/q`
...
Ovo je odvojeno od `2M_CODE.json`, koji konfiguriše ponašanje servera/izvršavanja.
...
Koristite `2M_CODE_TUI_CONFIG` da učitate prilagođenu putanju TUI konfiguracije.
