...
Agent skills omogucavaju 2M_CODE da pronade uputstva koja se mogu ponovo koristiti iz repozitorija ili home direktorija.
...
2M_CODE pretrazuje ove lokacije:

- Konfiguracija projekta: `.2M_CODE/skills/<name>/SKILL.md`
- Globalna konfiguracija: `~/.config/2M_CODE/skills/<name>/SKILL.md`
...
Za projektne lokalne putanje, 2M_CODE ide prema gore od trenutnog radnog direktorija dok ne dode do git worktree-ja.
Usput ucitava sve odgovarajuce `skills/*/SKILL.md` u `.2M_CODE/` i odgovarajuce `.claude/skills/*/SKILL.md` ili `.agents/skills/*/SKILL.md`.

Globalne definicije se takoder ucitavaju iz `~/.config/2M_CODE/skills/*/SKILL.md`, `~/.claude/skills/*/SKILL.md` i `~/.agents/skills/*/SKILL.md`.
...
Kreirajte `.2M_CODE/skills/git-release/SKILL.md` ovako:
...
2M_CODE navodi dostupne skills u opisu `skill` alata.
...
Kontrolisite kojim skills agenti mogu pristupiti pomocu dozvola baziranih na obrascima u `2M_CODE.json`:
...
**Za ugradene agente** (u `2M_CODE.json`):
