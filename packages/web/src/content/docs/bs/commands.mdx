...
Kreiraj `.2M_CODE/commands/test.md`:
...
Možete dodati prilagođene komande kroz 2M_CODE konfiguraciju ili kreiranjem markdown datoteka u direktoriju `commands/`.

---

### JSON

Koristite opciju `command` u svom 2M_CODE [config](/docs/config):
...
- Globalno: `~/.config/2M_CODE/commands/`
- Po projektu: `.2M_CODE/commands/`
...
2M_CODE uključuje nekoliko ugrađenih naredbi kao što su `/init`, `/undo`, `/redo`, `/share`, `/help`; [saznaj više](/docs/tui#commands).
:::note
