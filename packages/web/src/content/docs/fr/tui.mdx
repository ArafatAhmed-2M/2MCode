---
title: TUI
description: Utilisation de l’interface utilisateur du terminal 2M_CODE.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

2M_CODE fournit une interface de terminal interactif ou TUI pour travailler sur vos projets avec un LLM.

L’exécution de 2M_CODE démarre le TUI pour le répertoire actuel.
...
Lorsque vous utilisez le 2M_CODE TUI, vous pouvez taper `/` suivi d'un nom de commande pour exécuter rapidement des actions. Par exemple:
...
Ajoutez un fournisseur à 2M_CODE. Vous permet de sélectionner parmi les fournisseurs disponibles et d’ajouter leurs clés API.
...
Ceci est séparé de `2M_CODE.json`, qui configure le comportement du serveur/d'exécution.
...
Utilisez `2M_CODE_TUI_CONFIG` pour charger un chemin de configuration TUI personnalisé.
