...
description: Créez des outils que le LLM peut appeler dans 2M_CODE.
---

Les outils personnalisés sont des fonctions que vous créez et que le LLM peut appeler pendant les conversations. Ils fonctionnent avec les [outils intégrés](/docs/tools) de 2M_CODE comme `read`, `write` et `bash`.
...
- Localement en les plaçant dans le répertoire `.2M_CODE/tools/` de votre projet.
- Ou globalement, en les plaçant dans `~/.config/2M_CODE/tools/`.
