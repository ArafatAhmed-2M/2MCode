...
Crear `.2M_CODE/commands/test.md`:
...
Puede agregar comandos personalizados a través de la configuración 2M_CODE o creando archivos de Markdown en el directorio `commands/`.

---

### JSON

Utilice la opción `command` en su 2M_CODE [config](/docs/config):
...
2M_CODE incluye varios comandos integrados como `/init`, `/undo`, `/redo`, `/share`, `/help`; [más información](/docs/tui#commands).
