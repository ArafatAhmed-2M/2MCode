---
title: Compartir
description: Comparte tus conversaciones 2M_CODE.
---

La función para compartir de 2M_CODE te permite crear enlaces públicos a tus conversaciones de 2M_CODE, para que puedas colaborar con compañeros de equipo u obtener ayuda de otros.
...
Cuando compartes una conversación, 2M_CODE:
...
2M_CODE admite tres modos de compartir que controlan cómo se comparten las conversaciones:

---

### Manual (predeterminado)

De forma predeterminada, 2M_CODE usa el modo de compartir manual. Las sesiones no se comparten automáticamente, pero puedes compartirlas manualmente usando el comando `/share`:
...
Para aplicar esto en todo su equipo para un proyecto determinado, agréguelo al `2M_CODE.json` en su proyecto y regístrelo en Git.
...
[Obtenga más información](/docs/enterprise) sobre el uso de 2M_CODE en su organización.
