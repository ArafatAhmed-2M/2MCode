---
title: TUI
description: Usando la interfaz de usuario del terminal 2M_CODE.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

2M_CODE proporciona una interfaz de terminal interactiva o TUI para trabajar en sus proyectos con un LLM.

Al ejecutar 2M_CODE se inicia TUI para el directorio actual.
...
Cuando utilice 2M_CODE TUI, puede escribir `/` seguido de un nombre de comando para ejecutar acciones rápidamente. Por ejemplo:
...
Agregue un proveedor a 2M_CODE. Le permite seleccionar entre proveedores disponibles y agregar sus claves API.
...
Salga de 2M_CODE. _Alias_: `/quit`, `/q`
...
Esto es independiente de `2M_CODE.json`, que configura el comportamiento del servidor/tiempo de ejecución.
...
Utilice `2M_CODE_TUI_CONFIG` para cargar una ruta de configuración de TUI personalizada.
