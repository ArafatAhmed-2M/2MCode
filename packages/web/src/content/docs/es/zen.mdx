---
title: Zen
description: Lista seleccionada de modelos proporcionada por 2M_CODE.
---
...
2M_CODE Zen es una lista de modelos probados y verificados proporcionada por el equipo de 2M_CODE.

:::note
2M_CODE Zen está actualmente en beta.
:::

Zen funciona como cualquier otro proveedor en 2M_CODE. Inicias sesión en 2M_CODE Zen y obtienes
...
:::tip
Probamos un grupo selecto de modelos y proveedores que funcionan bien con 2M_CODE.
:::
...
2M_CODE Zen es un gateway de AI que te da acceso a estos modelos.

---

## Cómo funciona

2M_CODE Zen funciona como cualquier otro proveedor en 2M_CODE.

1. Inicias sesión en **<a href={console}>2M_CODE Zen</a>**, agregas tus datos de facturación
   y copias tu API key.
2. Ejecutas el comando `/connect` en la TUI, seleccionas 2M_CODE Zen y pegas tu API key.
...
El [identificador del modelo](/docs/config/#models) en tu configuración de 2M_CODE
usa el formato `2M_CODE/<model-id>`. Por ejemplo, para GPT 5.5, usarías
`2M_CODE/gpt-5.5` en tu configuración.
...
- DeepSeek V4 Flash Free está disponible en 2M_CODE por tiempo limitado. El equipo está usando este tiempo para recopilar comentarios y mejorar el modelo.
- MiniMax M2.5 Free está disponible en 2M_CODE por tiempo limitado. El equipo está usando este tiempo para recopilar comentarios y mejorar el modelo.
- Ring 2.6 1T Free está disponible en 2M_CODE por tiempo limitado. El equipo está usando este tiempo para recopilar comentarios y mejorar el modelo.
- Nemotron 3 Super Free está disponible en 2M_CODE por tiempo limitado. El equipo está usando este tiempo para recopilar comentarios y mejorar el modelo.
- Big Pickle es un modelo stealth que es gratuito en 2M_CODE por tiempo limitado. El equipo está usando este tiempo para recopilar comentarios y mejorar el modelo.
...
4. Que no haya **lock-in** al permitirte usarlo con cualquier otro agente de coding. Y permitirte siempre usar también cualquier otro proveedor con 2M_CODE.
