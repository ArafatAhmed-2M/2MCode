---
title: Condivisione
description: Condividi le tue conversazioni 2M_CODE.
---

La funzione di condivisione di 2M_CODE ti permette di creare link pubblici alle tue conversazioni, cosi puoi collaborare con i colleghi o chiedere aiuto ad altre persone.
...
Quando condividi una conversazione, 2M_CODE:
...
2M_CODE supporta tre modalita di condivisione che controllano come vengono condivise le conversazioni:

---

### Manuale (predefinito)

Per impostazione predefinita, 2M_CODE usa la condivisione manuale. Le sessioni non vengono condivise automaticamente, ma puoi condividerle manualmente con il comando `/share`:
...
Per applicarlo al tuo team in un progetto specifico, aggiungilo a `2M_CODE.json` nel progetto e versionalo su Git.
...
[Scopri di piu](/docs/enterprise) su come usare 2M_CODE nella tua organizzazione.
