...
Puoi aggiungere comandi personalizzati tramite la config di 2M_CODE o creando file markdown nella directory `commands/`.

---

### JSON

Usa l'opzione `command` nella [config](/docs/config) di 2M_CODE:
...
- Globale: `~/.config/2M_CODE/commands/`
- Per progetto: `.2M_CODE/commands/`
...
2M_CODE include diversi comandi integrati come `/init`, `/undo`, `/redo`, `/share`, `/help`; [scopri di piu](/docs/tui#commands).
