...
description: Crea strumenti che l'LLM puo chiamare in 2M_CODE.
---

Gli strumenti personalizzati sono funzioni che crei e che l'LLM puo chiamare durante le conversazioni. Funzionano insieme agli [strumenti integrati](/docs/tools) di 2M_CODE come `read`, `write` e `bash`.
...
- In locale, mettendoli nella directory `.2M_CODE/tools/` del progetto.
- Oppure in globale, mettendoli in `~/.config/2M_CODE/tools/`.
