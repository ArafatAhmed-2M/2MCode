...
description: Lag verktøy som LLM kan kalle inn 2M_CODE.
---

Egendefinerte verktøy er funksjoner du oppretter som LLM kan kalle under samtaler. De fungerer sammen med 2M_CODE sine [innebygde verktøy](/docs/tools) som `read`, `write` og `bash`.
...
- Lokalt ved å plassere dem i `.2M_CODE/tools/`-katalogen til prosjektet ditt.
- Eller globalt, ved å plassere dem i `~/.config/2M_CODE/tools/`.
