...
Opprett `.2M_CODE/commands/test.md`:
...
Du kan legge til egendefinerte kommandoer gjennom 2M_CODE-konfigurasjonen eller ved å lage markdown-filer i katalogen `commands/`.

---

### JSON

Bruk alternativet `command` i 2M_CODE [config](/docs/config):
...
2M_CODE inkluderer flere innebygde kommandoer som `/init`, `/undo`, `/redo`, `/share`, `/help`; [finn ut mer](/docs/tui#commands).
