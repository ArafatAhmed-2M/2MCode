...
Agentferdigheter lar 2M_CODE oppdage gjenbrukbare instruksjoner fra repo- eller hjemmekatalogen din.
...
For prosjektlokale stier går 2M_CODE opp fra din nåværende arbeidskatalog til den når git-arbeidstreet.
...
2M_CODE viser tilgjengelige ferdigheter i `skill`-verktøybeskrivelsen.
...
Kontroller hvilke ferdigheter agenter har tilgang til ved å bruke mønsterbaserte tillatelser i `2M_CODE.json`:
