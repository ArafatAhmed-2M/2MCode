...
2M_CODE har en liste over tastebindinger som du kan tilpasse gjennom `tui.json`.
...
2M_CODE bruker en `leader`-tast for de fleste tastebindinger. Dette unngår konflikter i terminalen din.
...
Prompt-feltet for 2M_CODE-skrivebordsappen støtter vanlige snarveier i Readline/Emacs-stil for redigering av tekst. Disse er innebygd og foreløpig ikke konfigurerbare via `2M_CODE.json`.
