---
title: Zen
description: Utvalgt liste over modeller levert av 2M_CODE.
---
...
2M_CODE Zen er en liste over testede og verifiserte modeller levert av 2M_CODE-teamet.

:::note
2M_CODE Zen er for øyeblikket i beta.
:::

Zen fungerer som enhver annen leverandør i 2M_CODE. Du logger inn på 2M_CODE Zen og får
...
:::tip
Vi testet en utvalgt gruppe modeller og leverandører som fungerer godt med 2M_CODE.
:::
...
2M_CODE Zen er en AI gateway som gir deg tilgang til disse modellene.

---

## Slik fungerer det

2M_CODE Zen fungerer som enhver annen leverandør i 2M_CODE.

1. Du logger inn på **<a href={console}>2M_CODE Zen</a>**, legger til
   faktureringsdetaljene dine og kopierer API-nøkkelen din.
2. Du kjører kommandoen `/connect` i TUI, velger 2M_CODE Zen og limer inn API-nøkkelen din.
...
[modell-id](/docs/config/#models) i 2M_CODE-konfigurasjonen din
bruker formatet `2M_CODE/<model-id>`. For eksempel, for GPT 5.5, ville du
brukt `2M_CODE/gpt-5.5` i konfigurasjonen din.
...
- DeepSeek V4 Flash Free er tilgjengelig på 2M_CODE i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
- MiniMax M2.5 Free er tilgjengelig på 2M_CODE i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
- Ring 2.6 1T Free er tilgjengelig på 2M_CODE i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
- Nemotron 3 Super Free er tilgjengelig på 2M_CODE i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
- Big Pickle er en stealth-modell som er gratis på 2M_CODE i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
...
Vi opprettet 2M_CODE Zen for å:
...
4. Ha **ingen lock-in** ved å la deg bruke det med enhver annen kodeagent. Og alltid la deg bruke enhver annen leverandør med 2M_CODE også.
