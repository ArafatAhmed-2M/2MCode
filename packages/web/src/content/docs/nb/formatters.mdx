---
title: Formattere
description: 2M_CODE bruker språkspesifikke formattere.
---

2M_CODE formaterer automatisk filer etter at de er skrevet eller redigert ved hjelp av språkspesifikke formattere. Dette sikrer at koden som genereres følger kodestilene til prosjektet ditt.

---

## Innebygde formattere

2M_CODE kommer med flere innebygde formattere for populære språk og rammeverk. Nedenfor er en liste over formattere, støttede filendelser og kommandoer eller konfigurasjonsalternativer den krever.
...
Så hvis prosjektet ditt har `prettier` i `package.json`, vil 2M_CODE automatisk bruke det.

---

## Slik fungerer det

Når 2M_CODE skriver eller redigerer en fil, gjør den:
...
Du kan tilpasse formattere gjennom `formatter`-delen i 2M_CODE-konfigurasjonen.
