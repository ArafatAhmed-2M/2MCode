---
title: SDK
description: Typesikker JS-klient for 2M_CODE-server.
---

import config from "../../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

2M_CODE JS/TS SDK gir en typesikker klient for samhandling med serveren.
Bruk den til å bygge integrasjoner og kontrollere 2M_CODE programmatisk.
...
Opprett en forekomst av 2M_CODE:
...
Du kan sende et konfigurasjonsobjekt for å tilpasse virkemåten. Forekomsten henter fortsatt din `2M_CODE.json`, men du kan overstyre eller legge til konfigurasjon inline:
...
Hvis du allerede har en kjørende forekomst av 2M_CODE, kan du opprette en klientforekomst for å koble til den:
