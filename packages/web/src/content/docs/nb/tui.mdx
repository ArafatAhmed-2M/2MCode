---
title: TUI
description: Bruke 2M_CODE-terminalbrukergrensesnittet.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

2M_CODE gir et interaktivt terminalgrensesnitt (TUI) for å jobbe med prosjektene dine med en LLM.

Å kjøre 2M_CODE starter TUI for gjeldende katalog.
...
Når du bruker 2M_CODE TUI, kan du skrive `/` etterfulgt av et kommandonavn for raskt å utføre handlinger. For eksempel:
...
Legg til en leverandør til 2M_CODE. Lar deg velge fra tilgjengelige leverandører og legge til deres API-nøkler.
...
Avslutt 2M_CODE. _Aliaser_: `/quit`, `/q`
...
Dette er atskilt fra `2M_CODE.json`, som konfigurerer server-/kjøretidsoppførsel.
...
Bruk `2M_CODE_TUI_CONFIG` for å laste en egendefinert TUI-konfigurasjonsbane.
