---
title: LSP-servere
description: 2M_CODE integreres med LSP-serverne dine.
---

2M_CODE integreres med din Language Server Protocol (LSP) for å hjelpe LLM med å samhandle med kodebasen din. Den bruker diagnostikk for å gi tilbakemelding til LLM.

---

## Innebygde servere

2M_CODE kommer med flere innebygde LSP-servere for populære språk:
...
:::note
Du kan deaktivere automatiske LSP-servernedlastinger ved å sette miljøvariabelen `2M_CODE_DISABLE_LSP_DOWNLOAD` til `true`.
:::
...
Når 2M_CODE åpner en fil, gjør den:
...
Du kan tilpasse LSP-servere gjennom `lsp`-delen i 2M_CODE-konfigurasjonen.
