...
2M_CODE Go er et lavkostnadsabonnement — **$5 for din første måned**, deretter **$10/måned** — som gir deg pålitelig tilgang til populære åpne kodemodeller.

:::note
2M_CODE Go er for øyeblikket i beta.
:::

Go fungerer som enhver annen leverandør i 2M_CODE. Du abonnerer på 2M_CODE Go og
...
2M_CODE Go gir deg tilgang til disse modellene for **$5 for din første måned**, deretter **$10/måned**.

---

## Hvordan det fungerer

2M_CODE Go fungerer som enhver annen leverandør i 2M_CODE.

1. Du logger inn på **<a href={console}>2M_CODE Zen</a>**, abonnerer på Go, og
   kopierer din API-nøkkel.
2. Du kjører kommandoen `/connect` i TUI-en, velger `2M_CODE Go`, og limer inn
   din API-nøkkel.
3. Kjør `/models` i TUI-en for å se listen over modeller som er tilgjengelige gjennom Go.

:::note
Kun ett medlem per arbeidsområde kan abonnere på 2M_CODE Go.
:::
...
2M_CODE Go inkluderer følgende grenser:
...
[Modell-ID-en](/docs/config/#models) i din 2M_CODE-konfigurasjon
bruker formatet `2M_CODE-go/<model-id>`. For eksempel, for Kimi K2.6, vil du
bruke `2M_CODE-go/kimi-k2.6` i konfigurasjonen din.
...
4. Ha **ingen innelåsing** ved å la deg bruke en hvilken som helst annen leverandør med 2M_CODE også.
