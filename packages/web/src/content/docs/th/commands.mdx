...
สร้าง `.2M_CODE/commands/test.md`:
...
ใช้ส่วน `command` ในไฟล์ [config](/docs/config) ของ 2M_CODE:
...
- ระดับผู้ใช้ (Global): `~/.config/2M_CODE/commands/`
- ระดับโปรเจ็กต์: `.2M_CODE/commands/`
...
2M_CODE มีคำสั่งในตัวหลายคำสั่ง เช่น `/init`, `/undo`, `/redo`, `/share`, `/help` [เรียนรู้เพิ่มเติม](/docs/tui#คำสั่ง)
