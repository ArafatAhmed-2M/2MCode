...
Create `.2M_CODE/commands/test.md`:
...
You can add custom commands through the 2M_CODE config or by creating markdown files in the `commands/` directory.

---

### JSON

Use the `command` option in your 2M_CODE [config](/docs/config):
...
2M_CODE includes several built-in commands like `/init`, `/undo`, `/redo`, `/share`, `/help`; [learn more](/docs/tui#commands).
