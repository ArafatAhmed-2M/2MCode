...
import { and, Database, eq, isNull, lt, or, sql } from "@2M_CODE-ai/console-core/drizzle/index.js"
import { KeyTable } from "@2M_CODE-ai/console-core/schema/key.sql.js"
import { BillingTable, LiteTable, SubscriptionTable, UsageTable } from "@2M_CODE-ai/console-core/schema/billing.sql.js"
import { centsToMicroCents } from "@2M_CODE-ai/console-core/util/price.js"
import { getMonthlyBounds, getWeekBounds } from "@2M_CODE-ai/console-core/util/date.js"
import { Identifier } from "@2M_CODE-ai/console-core/identifier.js"
import { Billing } from "@2M_CODE-ai/console-core/billing.js"
import { Actor } from "@2M_CODE-ai/console-core/actor.js"
import { WorkspaceTable } from "@2M_CODE-ai/console-core/schema/workspace.sql.js"
import { ZenData } from "@2M_CODE-ai/console-core/model.js"
import { Subscription } from "@2M_CODE-ai/console-core/subscription.js"
import { BlackData } from "@2M_CODE-ai/console-core/black.js"
import { UserTable } from "@2M_CODE-ai/console-core/schema/user.sql.js"
import { ModelTable } from "@2M_CODE-ai/console-core/schema/model.sql.js"
import { ProviderTable } from "@2M_CODE-ai/console-core/schema/provider.sql.js"
...
import { LiteData } from "@2M_CODE-ai/console-core/lite.js"
...
export async function handler(
  ...
  try {
    ...
    const sessionId = input.request.headers.get("x-2M_CODE-session") ?? ""
    const requestId = input.request.headers.get("x-2M_CODE-request") ?? ""
    const projectId = input.request.headers.get("x-2M_CODE-project") ?? ""
    const ocClient = input.request.headers.get("x-2M_CODE-client") ?? ""
    ...
    const retriableRequest = async (retry: RetryOptions = { excludeProviders: [], retryCount: 0 }) => {
      ...
      const res = await fetchWith429Retry(reqUrl, {
        ...
        headers: (() => {
          ...
          headers.delete("x-2M_CODE-request")
          headers.delete("x-2M_CODE-session")
          headers.delete("x-2M_CODE-project")
          headers.delete("x-2M_CODE-client")
          return headers
        })(),
        body: reqBody,
      })
  ...
  function validateBilling(authInfo: AuthInfo, modelInfo: ModelInfo): BillingSource {
    ...
    if (opts.modelList === "lite" && authInfo.billing.lite && authInfo.lite) {
      try {
        const consoleGoUrl = `https://2M_CODE.ai/workspace/${authInfo.workspaceID}/go`
    ...
    const billingUrl = `https://2M_CODE.ai/workspace/${authInfo.workspaceID}/billing`
    const membersUrl = `https://2M_CODE.ai/workspace/${authInfo.workspaceID}/members`
