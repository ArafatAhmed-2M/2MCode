...
import compareVideo from "../../asset/lander/2M_CODE-comparison-min.mp4"
import compareVideoPoster from "../../asset/lander/2M_CODE-comparison-poster.png"
...
export default function Home() {
  ...
  return (
    <main data-page="zen">
      ...
      <Meta name="2M_CODE:auth" content={loggedin() ? "true" : "false"} />
