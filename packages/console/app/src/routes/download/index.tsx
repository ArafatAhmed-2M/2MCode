...
import desktopAppIcon from "../../asset/lander/2M_CODE-desktop-icon.png"
      ...
      <div data-component="container">
        ...
        <div data-component="content">
          ...
          <section data-component="download-section">
            ...
            <div data-component="section-content">
              <button
                ...
                onClick={handleCopyClick("curl -fsSL https://2M_CODE.ai/install | bash")}
              >
                <code>
                  curl -fsSL https://<strong>2M_CODE.ai/install</strong> | bash
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("npm i -g 2M_CODE-ai")}>
                <code>
                  npm i -g <strong>2M_CODE-ai</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("bun add -g 2M_CODE-ai")}>
                <code>
                  bun add -g <strong>2M_CODE-ai</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("brew install anomalyco/tap/2M_CODE")}>
                <code>
                  brew install <strong>anomalyco/tap/2M_CODE</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("paru -S 2M_CODE")}>
                <code>
                  paru -S <strong>2M_CODE</strong>
                </code>
                <CopyStatus />
              </button>
            </div>
          ...
          <section data-component="download-section">
            ...
            <div data-component="section-content">
              <button data-component="cli-row" onClick={handleCopyClick("brew install --cask 2M_CODE-desktop")}>
                <code>
                  brew install --cask <strong>2M_CODE-desktop</strong>
                </code>
                <CopyStatus />
              </button>
