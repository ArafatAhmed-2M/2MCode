export const dict = {
  ...
  "dialog.provider.2M_CODE.note": "Curated models including Claude, GPT, Gemini and more",
  "dialog.provider.2M_CODE.tagline": "Reliable optimized models",
  "dialog.provider.2M_CODEGo.tagline": "Low cost subscription for everyone",
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by 2M_CODE",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in 2M_CODE.",
  "provider.connect.apiKey.label": "{{provider}} API key",
  "provider.connect.apiKey.placeholder": "API key",
  "provider.connect.apiKey.required": "API key is required",
  "provider.connect.2M_CODEZen.line1":
    "2M_CODE Zen gives you access to a curated set of reliable optimized models for coding agents.",
  "provider.connect.2M_CODEZen.line2":
    "With a single API key you'll get access to models such as Claude, GPT, Gemini, GLM and more.",
  "provider.connect.2M_CODEZen.visit.prefix": "Visit ",
  "provider.connect.2M_CODEZen.visit.link": "2M_CODE.ai/zen",
  "provider.connect.2M_CODEZen.visit.suffix": " to collect your API key.",
  "provider.connect.oauth.code.visit.prefix": "Visit ",
  "provider.connect.oauth.code.visit.link": "this link",
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in 2M_CODE.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in 2M_CODE.",
  ...
  "dialog.plugins.empty": "Plugins configured in 2M_CODE.json",
  ...
  "dialog.server.description": "Switch which 2M_CODE server this app connects to.",
  ...
  "toast.update.description": "A new version of 2M_CODE ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the 2M_CODE team",
  ...
  "error.chain.checkConfig": "Check your config (2M_CODE.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, 2M_CODE does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "2M_CODE includes free models so you can start immediately.",
  ...
  "settings.desktop.wsl.description": "Run the 2M_CODE server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for 2M_CODE",
  ...
  "settings.general.row.appearance.description": "Customise how 2M_CODE looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether 2M_CODE follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how 2M_CODE is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when 2M_CODE launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of 2M_CODE.",
