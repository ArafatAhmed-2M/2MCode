export const dict = {
  ...
  "dialog.provider.2M_CODE.note": "Wyselekcjonowane modele, w tym Claude, GPT, Gemini i inne",
  "dialog.provider.2M_CODE.tagline": "Niezawodne, zoptymalizowane modele",
  "dialog.provider.2M_CODEGo.tagline": "Tania subskrypcja dla każdego",
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez 2M_CODE",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w 2M_CODE.",
  ...
  "provider.connect.2M_CODEZen.line1":
    "2M_CODE Zen daje dostęp do wybranego zestawu niezawodnych, zoptymalizowanych modeli dla agentów kodujących.",
  ...
  "provider.connect.2M_CODEZen.visit.prefix": "Odwiedź ",
  "provider.connect.2M_CODEZen.visit.link": "2M_CODE.ai/zen",
  "provider.connect.2M_CODEZen.visit.suffix": ", aby odebrać swój klucz API.",
  "provider.connect.oauth.code.visit.prefix": "Odwiedź ",
  "provider.connect.oauth.code.visit.link": "ten link",
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w 2M_CODE.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w 2M_CODE.",
  ...
  "dialog.plugins.empty": "Wtyczki skonfigurowane w 2M_CODE.json",
  ...
  "dialog.server.description": "Przełącz serwer 2M_CODE, z którym łączy się ta aplikacja.",
  ...
  "toast.update.description": "Nowa wersja 2M_CODE ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu 2M_CODE",
  ...
  "error.chain.checkConfig": "Sprawdź swoją konfigurację (2M_CODE.json) nazwy dostawców/modeli",
  ...
  "sidebar.gettingStarted.line1": "2M_CODE zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla 2M_CODE",
  "settings.general.row.appearance.title": "Wygląd",
  "settings.general.row.appearance.description": "Dostosuj wygląd 2M_CODE na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy 2M_CODE ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw 2M_CODE.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania 2M_CODE",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji 2M_CODE.",
