...
export const dict = {
  ...
  "dialog.provider._2MCodeGo.tagline": "适合所有人的低成本订阅",
  ...
  "provider.connect._2MCodeZen.line1": "2M_CODE Zen 为你提供一组精选的可靠优化模型，用于代码智能体。",
  "provider.connect._2MCodeZen.line2": "只需一个 API 密钥，你就能使用 Claude、GPT、Gemini、GLM 等模型。",
  "provider.connect._2MCodeZen.visit.prefix": "访问 ",
  "provider.connect._2MCodeZen.visit.link": "2M_CODE.ai/zen",
  "provider.connect._2MCodeZen.visit.suffix": " 获取你的 API 密钥。",
