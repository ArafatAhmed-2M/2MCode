...
export const dict = {
  ...
  "dialog.provider.2M_CODE.note": "Kuratierte Modelle inklusive Claude, GPT, Gemini und mehr",
  "dialog.provider.2M_CODE.tagline": "Zuverlässige, optimierte Modelle",
  "dialog.provider._2MCodeGo.tagline": "Kostengünstiges Abo für alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Kostenlose Modelle von 2M_CODE",
  ...
  "provider.connect.apiKey.description":
    "Geben Sie Ihren {{provider}} API-Schlüssel ein, um Ihr Konto zu verbinden und {{provider}} Modelle in 2M_CODE zu nutzen.",
  ...
  "provider.connect._2MCodeZen.line1":
    "2M_CODE Zen bietet Ihnen Zugriff auf eine kuratierte Auswahl zuverlässiger, optimierter Modelle für Coding-Agenten.",
  ...
  "provider.connect._2MCodeZen.visit.prefix": "Besuchen Sie ",
  "provider.connect._2MCodeZen.visit.link": "2M_CODE.ai/zen",
  "provider.connect._2MCodeZen.visit.suffix": ", um Ihren API-Schlüssel zu erhalten.",
  "provider.connect.oauth.code.visit.prefix": "Besuchen Sie ",
  "provider.connect.oauth.code.visit.link": "diesen Link",
  "provider.connect.oauth.code.visit.suffix":
    ", um Ihren Autorisierungscode zu erhalten, Ihr Konto zu verbinden und {{provider}} Modelle in 2M_CODE zu nutzen.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " und geben Sie den untenstehenden Code ein, um Ihr Konto zu verbinden und {{provider}} Modelle in 2M_CODE zu nutzen.",
  ...
  "dialog.plugins.empty": "In 2M_CODE.json konfigurierte Plugins",
  ...
  "dialog.server.description": "Wechseln Sie den 2M_CODE-Server, mit dem sich diese App verbindet.",
  ...
  "toast.update.description": "Eine neue Version von 2M_CODE ({{version}}) ist zur Installation verfügbar.",
  ...
  "error.page.report.prefix": "Bitte melden Sie diesen Fehler dem 2M_CODE-Team",
  ...
  "error.chain.checkConfig": "Überprüfen Sie Ihre Konfiguration (2M_CODE.json) auf Anbieter-/Modellnamen",
  "error.chain.mcpFailed":
    'MCP-Server "{{name}}" fehlgeschlagen. Hinweis: 2M_CODE unterstützt noch keine MCP-Authentifizierung.',
  ...
  "sidebar.gettingStarted.line1": "2M_CODE enthält kostenlose Modelle, damit Sie sofort loslegen können.",
  ...
  "settings.desktop.wsl.description": "2M_CODE-Server innerhalb von WSL unter Windows ausführen.",
  ...
  "settings.general.row.language.description": "Die Anzeigesprache für 2M_CODE ändern",
  "settings.general.row.appearance.title": "Erscheinungsbild",
  "settings.general.row.appearance.description": "Anpassen, wie 2M_CODE auf Ihrem Gerät aussieht",
  "settings.general.row.colorScheme.title": "Farbschema",
  "settings.general.row.colorScheme.description":
    "Wählen Sie, ob 2M_CODE dem System-, hellen oder dunklen Thema folgt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Das Thema von 2M_CODE anpassen.",
  ...
  "settings.updates.row.startup.description": "Beim Start von 2M_CODE automatisch nach Updates suchen",
  ...
  "settings.updates.toast.latest.description": "Du verwendest die aktuelle Version von 2M_CODE.",
