...
export const dict = {
  ...
  "dialog.provider.2M_CODEGo.tagline": "適合所有人的低成本訂閱",
  ...
  "provider.connect.2M_CODEZen.line1": "2M_CODE Zen 為你提供一組精選的可靠最佳化模型，用於程式碼代理程式。",
  "provider.connect.2M_CODEZen.line2": "只需一個 API 金鑰，你就能使用 Claude、GPT、Gemini、GLM 等模型。",
  "provider.connect.2M_CODEZen.visit.prefix": "造訪 ",
  "provider.connect.2M_CODEZen.visit.link": "2M_CODE.ai/zen",
  "provider.connect.2M_CODEZen.visit.suffix": " 取得你的 API 金鑰。",
