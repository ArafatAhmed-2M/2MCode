...
export const dict = {
  ...
  "dialog.provider.2M_CODE.note": "Utvalgte modeller inkludert Claude, GPT, Gemini og mer",
  "dialog.provider.2M_CODE.tagline": "Pålitelige, optimaliserte modeller",
  "dialog.provider.2M_CODEGo.tagline": "Rimelig abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av 2M_CODE",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn din {{provider}} API-nøkkel for å koble til kontoen din og bruke {{provider}}-modeller i 2M_CODE.",
  ...
  "provider.connect.2M_CODEZen.line1":
    "2M_CODE Zen gir deg tilgang til et utvalg av pålitelige optimaliserte modeller for kodeagenter.",
  "provider.connect.2M_CODEZen.line2":
    "Med én enkelt API-nøkkel får du tilgang til modeller som Claude, GPT, Gemini, GLM og flere.",
  "provider.connect.2M_CODEZen.visit.prefix": "Besøk ",
  "provider.connect.2M_CODEZen.visit.link": "2M_CODE.ai/zen",
  "provider.connect.2M_CODEZen.visit.suffix": " for å hente API-nøkkelen din.",
  "provider.connect.oauth.code.visit.prefix": "Besøk ",
  "provider.connect.oauth.code.visit.link": "denne lenken",
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i 2M_CODE.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i 2M_CODE.",
  ...
  "dialog.plugins.empty": "Plugins konfigurert i 2M_CODE.json",
  ...
  "dialog.server.description": "Bytt hvilken 2M_CODE-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av 2M_CODE ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til 2M_CODE-teamet",
  ...
  "error.chain.checkConfig": "Sjekk leverandør-/modellnavnene i konfigurasjonen din (2M_CODE.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at 2M_CODE ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "2M_CODE inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.desktop.wsl.description": "Kjør 2M_CODE-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for 2M_CODE",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan 2M_CODE ser ut på enheten din",
  "settings.general.row.colorScheme.title": "Fargevalg",
  "settings.general.row.colorScheme.description": "Velg om 2M_CODE skal følge systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass hvordan 2M_CODE er tematisert.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når 2M_CODE starter",
  ...
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av 2M_CODE.",
