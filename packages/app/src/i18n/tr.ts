...
export const dict = {
  ...
  "dialog.provider.2M_CODEGo.tagline": "Herkes için düşük maliyetli abonelik",
  ...
  "provider.connect.2M_CODEZen.visit.suffix": " adresini ziyaret ederek API anahtarınızı alın.",
