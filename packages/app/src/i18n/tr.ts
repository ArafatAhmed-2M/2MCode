...
export const dict = {
  ...
  "dialog.provider.2M_CODE.note": "Claude, GPT, Gemini ve daha fazlasını içeren seçilmiş modeller",
  "dialog.provider.2M_CODE.tagline": "Güvenilir optimize edilmiş modeller",
  "dialog.provider._2MCodeGo.tagline": "Herkes için düşük maliyetli abonelik",
  ...
  "dialog.model.unpaid.freeModels.title": "2M_CODE tarafından sunulan ücretsiz modeller",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} hesabınızı bağlamak ve 2M_CODE'da {{provider}} modellerini kullanmak için {{provider}} API anahtarınızı girin.",
  ...
  "provider.connect._2MCodeZen.line1":
    "2M_CODE Zen, kodlama ajanları için seçilmiş güvenilir optimize edilmiş modellere erişim sağlar.",
  ...
  "provider.connect._2MCodeZen.visit.suffix": " adresini ziyaret ederek API anahtarınızı alın.",
  "provider.connect.oauth.code.visit.prefix":
    "Hesabınızı bağlamak ve 2M_CODE'da {{provider}} modellerini kullanmak için ",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " tıklayarak aşağıdaki kodu girin ve hesabınızı bağlayarak 2M_CODE'da {{provider}} modellerini kullanın.",
  ...
  "dialog.plugins.empty": "Eklentiler 2M_CODE.json içinde yapılandırılır",
  ...
  "dialog.server.description": "Bu uygulamanın hangi 2M_CODE sunucusuna bağlanacağını değiştirin.",
  ...
  "toast.update.description": "2M_CODE'un yeni bir sürümü ({{version}}) yüklemeye hazır.",
  ...
  "error.page.report.prefix": "Lütfen bu hatayı 2M_CODE ekibine bildirin",
  ...
  "error.chain.checkConfig": "Yapılandırma dosyanızı (2M_CODE.json) sağlayıcı/model adlarını kontrol edin",
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" başarısız oldu. Not: 2M_CODE henüz MCP kimlik doğrulamasını desteklemiyor.',
  ...
  "sidebar.gettingStarted.line1": "2M_CODE ücretsiz modeller içerir, böylece hemen başlayabilirsiniz.",
  ...
  "app.name.desktop": "2M_CODE Masaüstü",
  ...
  "settings.desktop.wsl.description": "2M_CODE sunucusunu Windows'ta WSL içinde çalıştırın.",
  ...
  "settings.general.row.language.description": "2M_CODE'un görünüm dilini değiştirin",
  "settings.general.row.appearance.title": "Görünüm",
  "settings.general.row.appearance.description": "2M_CODE'un cihazınızdaki görünümünü özelleştirin",
  "settings.general.row.colorScheme.title": "Renk şeması",
  "settings.general.row.colorScheme.description":
    "2M_CODE'un sistem, açık veya koyu temayı takip etip etmeyeceğini seçin",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "2M_CODE'un temasını özelleştirin.",
  ...
  "settings.updates.row.startup.description": "2M_CODE başladığında otomatik güncelleme kontrolü yap",
  ...
  "settings.updates.toast.latest.description": "2M_CODE'un en son sürümünü kullanıyorsunuz.",
