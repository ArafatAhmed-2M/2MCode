export const dict = {
  ...
  "dialog.provider.2M_CODE.note": "Modelos selecionados incluindo Claude, GPT, Gemini e mais",
  "dialog.provider.2M_CODE.tagline": "Modelos otimizados e confiáveis",
  "dialog.provider.2M_CODEGo.tagline": "Assinatura de baixo custo para todos",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos fornecidos pelo 2M_CODE",
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no 2M_CODE.",
  ...
  "provider.connect.2M_CODEZen.line1":
    "2M_CODE Zen oferece acesso a um conjunto selecionado de modelos confiáveis otimizados para agentes de código.",
  "provider.connect.2M_CODEZen.line2":
    "Com uma única chave de API você terá acesso a modelos como Claude, GPT, Gemini, GLM e mais.",
  "provider.connect.2M_CODEZen.visit.prefix": "Visite ",
  "provider.connect.2M_CODEZen.visit.link": "2M_CODE.ai/zen",
  "provider.connect.2M_CODEZen.visit.suffix": " para obter sua chave de API.",
  "provider.connect.oauth.code.visit.prefix": "Visite ",
  "provider.connect.oauth.code.visit.link": "este link",
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no 2M_CODE.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no 2M_CODE.",
  ...
  "dialog.plugins.empty": "Plugins configurados em 2M_CODE.json",
  ...
  "dialog.server.description": "Trocar para qual servidor 2M_CODE este aplicativo se conecta.",
  ...
  "toast.update.description": "Uma nova versão do 2M_CODE ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do 2M_CODE",
  ...
  "error.chain.checkConfig": "Verifique os nomes de provedor/modelo na sua configuração (2M_CODE.json)",
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: 2M_CODE ainda não suporta autenticação MCP.',
  ...
  "sidebar.gettingStarted.line1": "2M_CODE inclui modelos gratuitos para você começar imediatamente.",
  ...
  "app.name.desktop": "2M_CODE Desktop",
  ...
  "settings.desktop.wsl.description": "Executar o servidor 2M_CODE dentro do WSL no Windows.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do 2M_CODE",
  "settings.general.row.appearance.title": "Aparência",
  "settings.general.row.appearance.description": "Personalize como o 2M_CODE aparece no seu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de cores",
  "settings.general.row.colorScheme.description": "Escolha se o 2M_CODE segue o tema do sistema, claro ou escuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o 2M_CODE é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o 2M_CODE iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do 2M_CODE.",
