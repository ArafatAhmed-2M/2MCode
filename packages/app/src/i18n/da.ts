export const dict = {
  ...
  "dialog.provider.2M_CODE.note": "Udvalgte modeller inklusive Claude, GPT, Gemini og flere",
  "dialog.provider.2M_CODE.tagline": "Pålidelige optimerede modeller",
  "dialog.provider.2M_CODEGo.tagline": "Billigt abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller leveret af 2M_CODE",
  ...
  "provider.connect.apiKey.description":
    "Indtast din {{provider}} API-nøgle for at forbinde din konto og bruge {{provider}} modeller i 2M_CODE.",
  ...
  "provider.connect.2M_CODEZen.line1":
    "2M_CODE Zen giver dig adgang til et udvalg af pålidelige optimerede modeller til kodningsagenter.",
  "provider.connect.2M_CODEZen.line2":
    "Med en enkelt API-nøgle får du adgang til modeller som Claude, GPT, Gemini, GLM og flere.",
  "provider.connect.2M_CODEZen.visit.prefix": "Besøg ",
  "provider.connect.2M_CODEZen.visit.link": "2M_CODE.ai/zen",
  "provider.connect.2M_CODEZen.visit.suffix": " for at hente din API-nøgle.",
  "provider.connect.oauth.code.visit.prefix": "Besøg ",
  "provider.connect.oauth.code.visit.link": "dette link",
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode for at forbinde din konto og bruge {{provider}} modeller i 2M_CODE.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge {{provider}} modeller i 2M_CODE.",
  ...
  "dialog.plugins.empty": "Plugins konfigureret i 2M_CODE.json",
  ...
  "dialog.server.description": "Skift hvilken 2M_CODE-server denne app forbinder til.",
  ...
  "toast.update.description": "En ny version af 2M_CODE ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til 2M_CODE-teamet",
  ...
  "error.chain.checkConfig": "Tjek dine konfigurations (2M_CODE.json) udbyder/modelnavne",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" fejlede. Bemærk, 2M_CODE understøtter ikke MCP-godkendelse endnu.',
  ...
  "sidebar.gettingStarted.line1": "2M_CODE inkluderer gratis modeller så du kan starte med det samme.",
  ...
  "settings.desktop.wsl.description": "Kør 2M_CODE-serveren inde i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for 2M_CODE",
  "settings.general.row.appearance.title": "Udseende",
  "settings.general.row.appearance.description": "Tilpas hvordan 2M_CODE ser ud på din enhed",
  "settings.general.row.colorScheme.title": "Farveskema",
  "settings.general.row.colorScheme.description": "Vælg om 2M_CODE følger systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas hvordan 2M_CODE er temabestemt.",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når 2M_CODE starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af 2M_CODE.",
