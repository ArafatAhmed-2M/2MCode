import { Message, Model, Part, Session, SessionStatus, SnapshotFileDiff, UserMessage } from "@2mcode-ai/sdk/v2"
import { SessionTurn } from "@2mcode-ai/ui/session-turn"
import { SessionReview } from "@2mcode-ai/ui/session-review"
import { DataProvider } from "@2mcode-ai/ui/context"
import { FileComponentProvider } from "@2mcode-ai/ui/context/file"
import { WorkerPoolProvider } from "@2mcode-ai/ui/context/worker-pool"
import { createAsync, query, useParams } from "@solidjs/router"
import { createMemo, createSignal, ErrorBoundary, For, Match, Show, Switch } from "solid-js"
import { Share } from "~/core/share"
import { Logo, Mark } from "@2mcode-ai/ui/logo"
...
import { Tabs } from "@2mcode-ai/ui/tabs"
import { MessageNav } from "@2mcode-ai/ui/message-nav"
import { FileSSR } from "@2mcode-ai/ui/file-ssr"
...
const ClientOnlyWorkerPoolProvider = clientOnly(() =>
  import("@2mcode-ai/ui/pierre/worker").then((m) => ({
