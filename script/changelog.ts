...
Generates UPCOMING_CHANGELOG.md by running the 2M_CODE changelog command.

Options:
  -f, --from <version>   Starting version (default: latest non-draft GitHub release)
  -t, --to <ref>         Ending ref (default: HEAD)
      --variant <name>   Thinking variant for 2M_CODE run (default: low)
      --quiet            Suppress 2M_CODE command output unless it fails
