...
async function fetchReleases(): Promise<Release[]> {
  ...
  while (true) {
    const url = `https://api.github.com/repos/anomalyco/2M_CODE/releases?page=${page}&per_page=${per}`
...
console.log("Fetching GitHub releases for anomalyco/2M_CODE...\n")
...
console.log("Fetching npm all-time downloads for 2M_CODE-ai...\n")
const npmDownloads = await fetchNpmDownloads("2M_CODE-ai")
